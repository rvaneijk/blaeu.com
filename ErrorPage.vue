    ...
    <div class="max-w-lg w-full text-center">
      ...
      <div class="text-sm text-gray-500">
        <p>If this problem persists, please 
          <a href="mailto:support@blaeu.com" class="text-indigo-600 hover:text-indigo-800 underline">
            contact support
          </a>
        </p>
      </div>
...
const errorMessage = computed(() => getErrorMessage(props.error.statusCode, props.error.statusMessage || props.error.message))
