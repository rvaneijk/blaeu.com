...
export function useInfiniteScroll<T>(options: UseInfiniteScrollOptions = {}): UseInfiniteScrollReturn<T> {
  const { batchSize = 3, initialCount = 5, rootMargin = '100px', threshold = 0.1, enabled = true } = options
