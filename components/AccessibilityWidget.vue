  ...
  >
    ...
    >
      <div class="accessibility-widget-header">
        <h2 id="accessibility-widget-title" class="accessibility-widget-title">Accessibility Settings</h2>
        <button 
      ...
      <div class="accessibility-widget-content">
        ...
        <div class="accessibility-control">
          <label id="font-family-control-label">Font Family</label>
        ...
        <!-- Contrast controls -->
        <div class="accessibility-control">
          <label id="contrast-control-label">Contrast</label>
        ...
        <div class="accessibility-control">
          <label id="position-control-label">Widget Position</label>
          <div class="button-group position-controls-simplified" role="radiogroup" aria-labelledby="position-control-label">
            ...
            >
              ...
              <span class="position-label">Left-handed</span>
            </button>
            <button 
            ...
            >
              ...
              <span class="position-label">Right-handed</span>
            </button>
          </div>
        </div>
        ...
        <div class="accessibility-control keyboard-shortcuts-hint" @click="showKeyboardShortcuts">
          <div class="flex items-center text-sm text-gray-500 cursor-pointer hover:text-gray-700">
            ...
            <span>Press <kbd class="bg-gray-100 px-1 rounded border border-gray-300 text-xs">Alt</kbd> + <kbd class="bg-gray-100 px-1 rounded border border-gray-300 text-xs">/</kbd> for keyboard shortcuts</span>
          </div>
        </div>
      </div>
    </div>
