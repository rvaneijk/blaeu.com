...
<script setup lang="ts">
  ...
  const fontsOpendyslexicUrl = '/assets/css/fonts-opendyslexic.css'
  ...
  const applyFontFamily = (): void => {
    if (currentFontFamily.value === 'dyslexic') {
      ...
      if (!document.querySelector('link[rel="stylesheet"][href*="fonts-opendyslexic"]')) {
        const link = document.createElement('link')
        link.rel = 'stylesheet'
        link.href = fontsOpendyslexicUrl
        link.media = 'all'
