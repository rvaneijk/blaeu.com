...
<template>
  <div
    v-show="hydrated && (!hasBeenOpenedBefore || isOpen)"
    ref="widgetRef"
    :class="[
  ...
  >
    ...
    <span v-if="!isOpen" class="widget-toggle-tooltip">Cookie policy</span>
        ...
        <div class="cookie-policy-header-actions">
          <a
            ...
            :class="[
              'gpc-badge',
              'no-external-icon',
              gpcDetected ? 'gpc-badge--honored' : 'gpc-badge--inactive',
            ]"
            role="status"
            :aria-label="gpcAriaLabel"
          >
            GPC
            <span class="gpc-badge-tooltip" aria-hidden="true">{{ gpcTooltipText }}</span>
          </a>
          <button
      ...
      <div class="cookie-policy-widget-content">
        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-1 mb-0">Last Updated: February 17, 2026</p>
          </div>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-1 mb-0">Laatst bijgewerkt: 17 februari 2026</p>
          </div>
        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Last Updated: February 17, 2026</p>
            ...
            <ol class="list-decimal pl-6 space-y-2">
              <li>
                ...
                mode, focus indicators, reduced motion settings, font family, widget position, dark
                mode, and your preferred language for keyboard shortcuts (English or Dutch). This
                allows us to optimize your WCAG preferences.
              </li>
              <li>
                <strong>Cookie Notice Acknowledgment (cookie-policy-shown):</strong>
                We record that (not when) you have viewed our cookie policy. This stops the blinking
                notification after your first visit, providing a better user experience while still
                meeting regulatory requirements to inform users about our Cookie Policy.
              </li>
              <li>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Laatst bijgewerkt: 17 februari 2026</p>
            ...
            <ul class="custom-bullet-list">
              ...
              <li>Geen verzameling van persoonsgegevens via cookies</li>
            ...
            <ol class="list-decimal pl-6 space-y-2">
              <li>
                ...
                beweging, lettertype, widgetpositie, donkere modus, en uw voorkeurstaal voor
            ...
            <p>
              ...
              <a href="#" class="text-blue-700 hover:underline" @click.prevent="showPrivacyPolicy">
                Privacyverklaring
              </a>
              .
            </p>
...
<script setup lang="ts">
  ...
  const gpcTooltipText = computed(() => {
    if (gpcDetected.value) {
      return currentLanguage.value === 'nl'
        ? 'GPC-signaal gehonoreerd. Klik voor meer informatie over Global Privacy Control.'
        : 'GPC signal honored. Click to learn more about Global Privacy Control.'
    }
    return currentLanguage.value === 'nl'
      ? 'Geen GPC-signaal gedetecteerd. Klik voor meer informatie over Global Privacy Control.'
      : 'No GPC signal detected. Click to learn more about Global Privacy Control.'
  })

  const gpcAriaLabel = computed(() => {
    if (gpcDetected.value) {
      return currentLanguage.value === 'nl'
        ? 'GPC-signaal gehonoreerd – klik voor meer informatie'
        : 'GPC signal honored – click to learn more'
    }
    return currentLanguage.value === 'nl'
      ? 'Geen GPC-signaal gedetecteerd – klik voor meer informatie'
      : 'No GPC signal detected – click to learn more'
  })
  ...
  const hasBeenOpenedBefore = ref(
    process.client
      ? localStorage.getItem('cookie-policy-shown') === 'true'
      : globalState.cookiePolicyAcknowledged
  )
...
1. Toegankelijkheidsvoorkeuren (accessibility-state): Onze toegankelijkheidswidget slaat uw toegankelijkheidsvoorkeuren op in local storage om uw instellingen tussen bezoeken te onthouden. Deze voorkeuren omvatten tekstgrootte, contrastmodus, focusindicatoren, instellingen voor verminderde beweging, lettertype, links/rechtshandige widget-positionering, donkere modus, en uw voorkeurstaal voor toetsenbordsnelkoppelingen (Nederlands of Engels).
...
1. Accessibility Preferences (accessibility-state): Our accessibility widget stores your accessibility preferences in local storage to remember your settings between visits. These preferences include text size, contrast mode, focus indicators, reduced motion settings, font family, left/right-handed widget positioning, dark mode, and your preferred language for keyboard shortcuts (English or Dutch).

2. Cookie Notice Acknowledgment (cookie-policy-shown): We record that (not when) you have viewed our cookie policy. This stops the blinking notification after your first visit, providing a better user experience while still meeting regulatory requirements to inform users about our Cookie Policy.
...
If there is an inconsistency between the Dutch and English-language version of these regulations, the Dutch version takes precedence.`
  ...
  // Sync hasBeenOpenedBefore to globalState for other components (e.g. back-to-top positioning)
  watch(hasBeenOpenedBefore, newValue => {
    if (newValue) {
      globalState.cookiePolicyAcknowledged = true
    }
  })
...
<style scoped>
  ...
  @media (min-width: 768px) {
    .cookie-policy-widget:hover .widget-toggle-tooltip {
      opacity: 1;
    }
    .cookie-policy-widget:active .widget-toggle-tooltip {
      opacity: 0;
    }
  }
  ...
  @media (min-width: 768px) {
    .gpc-badge:hover .gpc-badge-tooltip,
    .gpc-badge:focus .gpc-badge-tooltip {
      opacity: 1;
    }
  }

  :global(.high-contrast-mode) .gpc-badge--honored,
  :global(.high-contrast-mode) .gpc-badge--inactive {
    background-color: #000;
    color: #fff;
    border: 1px solid #fff;
  }
