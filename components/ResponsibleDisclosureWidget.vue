      ...
      <div class="responsible-disclosure-widget-content">
        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-2">Last Updated: March 9, 2026</p>
          </div>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-2">Laatst bijgewerkt: 9 maart 2026</p>
          </div>
        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Last Updated: March 9, 2026</p>
            ...
            <ul class="custom-bullet-list">
              ...
              <li>
                ...
                as possible. Usually, the IP address or the URL of the affected system and a
                description of the vulnerability will be sufficient, but complex vulnerabilities may
                require further explanation.
              </li>
            </ul>

            <h3 class="text-xl font-semibold mt-6 mb-3">NOT ELIGIBLE FOR A REWARD:</h3>
            <ul class="custom-bullet-list">
              <li>Missing HTTP security headers, unless they directly enable an attack,</li>
              <li>
                Version number or software configuration disclosure without a demonstrable exploit,
              </li>
              <li>Weak TLS or cipher configurations without a working proof of concept,</li>
              <li>Clickjacking without demonstrated security impact,</li>
              <li>
                Known vulnerable libraries or components without a proof of concept specific to our
                implementation,
              </li>
              <li>
                Reports consisting solely of automated scanning tool output, without manual
                verification and a working proof of concept,
              </li>
              <li>Reports generated solely by AI,</li>
              <li>
                Theoretical issues, hardening recommendations, and best-practice configurations
                without demonstrable risk,
              </li>
              <li>Findings we have reviewed and classified as accepted risk,</li>
              <li>
                Duplicate findings — only the first reporter of a unique vulnerability is eligible
                for a reward,
              </li>
              <li>Social engineering, phishing, spam or denial-of-service attacks, and</li>
              <li>Vulnerabilities in third-party services not managed by us.</li>
            </ul>
            ...
            <ul class="custom-bullet-list">
              ...
              <li>
                We offer a reward for every unique, first-reported security problem not previously
                known to us that meets the above conditions. The reward is based on severity (CVSS
                score) and report quality, with a minimum of a €50 gift voucher via the Giftogram
                Global Rewards programme. Low-severity and informational findings are not eligible.
                Where the same vulnerability is reported by multiple researchers, only the first
                reporter is eligible. The final determination of severity and reward rests with us.
              </li>
            </ul>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Laatst bijgewerkt: 9 maart 2026</p>
            ...
            <h3 class="text-xl font-semibold mt-6 mb-3">NIET IN AANMERKING VOOR BELONING:</h3>
            <ul class="custom-bullet-list">
              <li>
                Ontbrekende HTTP-beveiligingsheaders, tenzij deze direct een aanval mogelijk maken,
              </li>
              <li>
                Vermelding van versienummers of softwareconfiguraties zonder aantoonbaar misbruik,
              </li>
              <li>Zwakke TLS- of cipher-configuraties zonder werkend bewijs van uitbuiting,</li>
              <li>Clickjacking zonder aangetoond beveiligingsrisico,</li>
              <li>
                Bekende kwetsbare bibliotheken of componenten zonder een op onze specifieke
                implementatie gerichte proof of concept,
              </li>
              <li>
                Meldingen die uitsluitend bestaan uit de uitvoer van geautomatiseerde scantools,
                zonder handmatige verificatie en werkende proof of concept,
              </li>
              <li>Meldingen die uitsluitend door AI zijn gegenereerd,</li>
              <li>
                Theoretische problemen, hardening-aanbevelingen en best-practice-configuraties
                zonder aantoonbaar risico,
              </li>
              <li>Bevindingen die wij na beoordeling als geaccepteerd risico hebben aangemerkt,</li>
              <li>
                Dubbele meldingen — alleen de eerste melder van een unieke kwetsbaarheid komt in
                aanmerking voor beloning,
              </li>
              <li>Social engineering, phishing, spam of denial-of-service-aanvallen, en</li>
              <li>Kwetsbaarheden in diensten van derden die niet door ons worden beheerd.</li>
            </ul>
            ...
            <ul class="custom-bullet-list">
              ...
              <li>
                Wij bieden een beloning voor elke unieke, eerste melding van een
                beveiligingsprobleem dat bij ons nog niet bekend is en voldoet aan bovenstaande
                voorwaarden. De beloning is gebaseerd op de ernst (CVSS-score) en de kwaliteit van
                de melding, met een minimum van een cadeaubon van €50 via het Giftogram Global
                Rewards programma. Lage en informatieve kwetsbaarheden komen niet in aanmerking. Bij
                meerdere meldingen van hetzelfde probleem ontvangt alleen de eerste melder een
                beloning. De definitieve beoordeling van ernst en beloning berust bij ons.
              </li>
            </ul>
...
<script setup lang="ts">
  ...
  const DOWNLOAD_CONTENT_NL = `RESPONSIBLE DISCLOSURE BELEID - TEAM BLAEU (BLAEU PRIVACY RESPONSE TEAM B.V.)
...
NIET IN AANMERKING VOOR BELONING:
- Ontbrekende HTTP-beveiligingsheaders, tenzij deze direct een aanval mogelijk maken,
- Vermelding van versienummers of softwareconfiguraties zonder aantoonbaar misbruik,
- Zwakke TLS- of cipher-configuraties zonder werkend bewijs van uitbuiting,
- Clickjacking zonder aangetoond beveiligingsrisico,
- Bekende kwetsbare bibliotheken of componenten zonder een op onze specifieke implementatie gerichte proof of concept,
- Meldingen die uitsluitend bestaan uit de uitvoer van geautomatiseerde scantools, zonder handmatige verificatie en werkende proof of concept,
- Meldingen die uitsluitend door AI zijn gegenereerd,
- Theoretische problemen, hardening-aanbevelingen en best-practice-configuraties zonder aantoonbaar risico,
- Bevindingen die wij na beoordeling als geaccepteerd risico hebben aangemerkt,
- Dubbele meldingen — alleen de eerste melder van een unieke kwetsbaarheid komt in aanmerking voor beloning,
- Social engineering, phishing, spam of denial-of-service-aanvallen, en
- Kwetsbaarheden in diensten van derden die niet door ons worden beheerd.
...
- Wij bieden een beloning voor elke unieke, eerste melding van een beveiligingsprobleem dat bij ons nog niet bekend is en voldoet aan bovenstaande voorwaarden. De beloning is gebaseerd op de ernst (CVSS-score) en de kwaliteit van de melding, met een minimum van een cadeaubon van EUR 50 via het Giftogram Global Rewards programma (https://giftogram.com/global-rewards). Lage en informatieve kwetsbaarheden komen niet in aanmerking. Bij meerdere meldingen van hetzelfde probleem ontvangt alleen de eerste melder een beloning. De definitieve beoordeling van ernst en beloning berust bij ons.
...
Wij streven ernaar alle problemen zo snel mogelijk op te lossen en wij willen graag betrokken worden bij een eventuele publicatie over het probleem nadat het is opgelost.`
  ...
  const DOWNLOAD_CONTENT_EN = `RESPONSIBLE DISCLOSURE POLICY - TEAM BLAEU (BLAEU PRIVACY RESPONSE TEAM B.V.)
...
- Social engineering, phishing, spam or denial-of-service attacks, and
...
- We offer a reward for every unique, first-reported security problem not previously known to us that meets the above conditions. The reward is based on severity (CVSS score) and report quality, with a minimum of a EUR 50 gift voucher via the Giftogram Global Rewards programme (https://giftogram.com/global-rewards). Low-severity and informational findings are not eligible. Where the same vulnerability is reported by multiple researchers, only the first reporter is eligible. The final determination of severity and reward rests with us.
...
If there is an inconsistency between the Dutch and English-language version of these regulations, the Dutch version takes precedence.`
  ...
  const downloadPolicy = (): void => {
    ...
    const content = isNL ? DOWNLOAD_CONTENT_NL : DOWNLOAD_CONTENT_EN
