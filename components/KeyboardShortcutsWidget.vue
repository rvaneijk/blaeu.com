      ...
      <div class="keyboard-shortcuts-widget-content">
        ...
        <div id="full-shortcuts-content" class="full-shortcuts">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <!-- Widget Shortcuts -->
            <section>
              <h3 class="text-xl font-semibold mt-6 mb-3">Widget Shortcuts</h3>
              <ul class="list-none pl-0 space-y-2">
                <li
                  v-for="(shortcut, index) in englishShortcuts.widgets"
                  :key="'widgets-' + index"
                  class="flex items-center"
                >
                  <div class="flex items-center min-w-[120px]">
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <!-- Widget Shortcuts -->
            <section>
              <h3 class="text-xl font-semibold mt-6 mb-3">Widgetsnelkoppelingen</h3>
              <ul class="list-none pl-0 space-y-2">
                <li
                  v-for="(shortcut, index) in dutchShortcuts.widgets"
                  :key="'widgets-nl-' + index"
                  class="flex items-center"
                >
                  <div class="flex items-center min-w-[120px]">
                    <template v-for="(key, keyIndex) in shortcut.keys.split('+')" :key="keyIndex">
...
<script setup lang="ts">
  ...
  const englishShortcuts = ref({
    ...
    accessibility: [
      ...
      { keys: 'Alt+D', description: 'Toggle dyslexia-friendly font' },
      { keys: 'Alt+F', description: 'Toggle focus mode' },
      { keys: 'Alt+M', description: 'Toggle dark mode' },
      { keys: 'Alt+X', description: 'Toggle high contrast mode' },
      { keys: 'Alt+Z', description: 'Toggle reduce motion' },
    ],
    widgets: [
      { keys: 'Alt+C', description: 'Open cookie policy' },
      { keys: 'Alt+K', description: 'Toggle keyboard shortcuts' },
      { keys: 'Alt+P', description: 'Open privacy statement' },
      { keys: 'Alt+T', description: 'Open terms of use' },
    ],
    browser: [
  ...
  const dutchShortcuts = ref({
    ...
    accessibility: [
      ...
      { keys: 'Alt+D', description: 'Dyslexievriendelijk lettertype aan/uit' },
      { keys: 'Alt+F', description: 'Focusmodus aan/uit' },
      { keys: 'Alt+M', description: 'Donkere modus aan/uit' },
      { keys: 'Alt+X', description: 'Hoog contrast modus aan/uit' },
      { keys: 'Alt+Z', description: 'Verminderde beweging aan/uit' },
    ],
    widgets: [
      { keys: 'Alt+C', description: 'Open cookiebeleid' },
      { keys: 'Alt+K', description: 'Toetsenbordsnelkoppelingen aan/uit' },
      { keys: 'Alt+P', description: 'Open privacyverklaring' },
      { keys: 'Alt+T', description: 'Open gebruiksvoorwaarden' },
    ],
    browser: [
