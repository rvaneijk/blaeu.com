...
<script setup lang="ts">
  ...
  import keynoteContentData from '~/data/keynote-speaker.json'
  ...
  const availableCategories = computed(() => {
    ...
    const categoryOrder = ['Keynotes', 'Opening Remarks']
  ...
  onMounted(async () => {
    try {
      ...
      // Use the keynote speaker JSON data
      mediaData.value = keynoteContentData as MediaContentData
