...
<template>
  ...
  <nav 
    ...
    :class="{'bg-white shadow-md opacity-100': scrolled || globalState.reduceMotion, 'bg-transparent opacity-0 pointer-events-none': !scrolled && !globalState.reduceMotion && !mobileMenuOpen, 'bg-transparent': !scrolled && !globalState.reduceMotion && mobileMenuOpen}"
    aria-hidden="false"
  >
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-16">
        <!-- Logo/Brand - Using NuxtLink for SPA navigation -->
        ...
        <button 
          ...
          :class="{
            'text-gray-600 hover:text-gray-900': scrolled || globalState.reduceMotion, 
            'text-white hover:text-gray-200': !scrolled && !globalState.reduceMotion
          }"
        ...
        <div class="hidden md:flex md:items-center md:space-x-8 font-amblelight" role="navigation" aria-label="Desktop Navigation" tabindex="-1">
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'top', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'top',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'top' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'top' && !scrolled
            }"
          ...
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'book', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'book',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'book' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'book' && !scrolled
            }"
          ...
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'research', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'research',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'research' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'research' && !scrolled
            }"
          ...
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'media', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'media',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'media' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'media' && !scrolled
            }"
            :aria-current="activeSection === 'media' ? 'page' : undefined"
          >
            <span class="flex items-center">Thought Leadership</span>
          </a>
          <a 
            href="#about" 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'about', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'about',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'about' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'about' && !scrolled
            }"
...
const scrollTo = (selector) => {
  ...
  if (nuxtApp.$announce) {
    ...
    const sectionLabels = {
      ...
      'media': 'media and thought leadership',
