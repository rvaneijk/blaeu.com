      ...
      <div class="accessibility-policy-widget-content">
        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-2">Last Updated: April 2, 2025</p>
          </div>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-2">Laatst bijgewerkt: 2 april 2025</p>
          </div>
        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Last Updated: April 2, 2025</p>
            ...
            <section class="mt-6">
              ...
              <p class="mt-2">The website features two pages (homepage with silent video and a personal page) with no forms, input fields, or authentication mechanisms. To the best of our knowledge, this website is fully conformant with WCAG 2.2 level A standards, with most AA and several AAA enhancements.</p>
            </section>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <p class="text-gray-500 mt-4">Laatst bijgewerkt: 2 april 2025</p>
            ...
            <section class="mt-6">
              ...
              <p class="mt-2">De website bestaat uit twee pagina's (homepage met stille video en een persoonlijke pagina) zonder formulieren, invoervelden of authenticatiemechanismen. Voor zover wij weten is deze website volledig conform WCAG 2.2 niveau A-standaarden, met de meeste AA- en verschillende AAA-verbeteringen.</p>
            </section>
