        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <p class="mt-2">
                The website features multiple pages (including a homepage with silent video, a
                personal profile page, a blog, and a recordings page) with no forms, input fields,
                or authentication mechanisms. This form-free approach significantly reduces
                potential accessibility barriers for users with disabilities. To the best of our
                knowledge, this website is fully conformant with WCAG 2.2 level A standards, with
                most AA and several AAA enhancements.
              </p>
            </section>
            ...
            <section class="mt-6">
              ...
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Widget Shortcuts</h4>
              <ul class="custom-bullet-list space-y-1">
                <li>
                  <strong>Alt + C:</strong>
                  Open cookie policy
            ...
            <section class="mt-6">
              ...
              <p class="mt-2">
                Access the widget using the accessibility icon in the navigation bar or by pressing
                <strong>Alt + A</strong>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <p>
                De Web Content Accessibility Guidelines (WCAG) definiëren eisen voor ontwerpers en
                ontwikkelaars om de toegankelijkheid voor mensen met een beperking te verbeteren. De
                WCAG definiëren drie conformiteitsniveaus: Niveau A, Niveau AA en Niveau AAA.
              </p>
              <p class="mt-2">
                De website bestaat uit meerdere pagina's (waaronder een homepage met stille video,
                een persoonlijk profiel, een blog en een opnamepagina) zonder formulieren,
                invoervelden of authenticatiemechanismen. Deze formuliervrije aanpak vermindert
                aanzienlijk mogelijke toegankelijkheidsbarrières voor gebruikers met een beperking.
                Voor zover wij weten is deze website volledig conform WCAG 2.2 niveau A-standaarden,
                met de meeste AA- en verschillende AAA-verbeteringen.
              </p>
            </section>
            ...
            <section class="mt-6">
              ...
              <ul class="custom-bullet-list space-y-1">
                ...
                <li>
                  <strong>Alt + D:</strong>
                  Dyslexievriendelijk lettertype aan/uit
                </li>
                <li>
                  <strong>Alt + F:</strong>
              ...
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Widgetsnelkoppelingen</h4>
              <ul class="custom-bullet-list space-y-1">
                <li>
                  <strong>Alt + C:</strong>
                  Open cookiebeleid
                ...
                <li>
                  <strong>Alt + K:</strong>
                  Toetsenbordsnelkoppelingen aan/uit
                </li>
                <li>
                  <strong>Alt + P:</strong>
                  Open privacyverklaring
                </li>
                <li>
                  <strong>Alt + T:</strong>
                  Open gebruiksvoorwaarden
                </li>
              </ul>
            ...
            <section class="mt-6">
              ...
              <p class="mt-2">
                Toegang tot de widget via het toegankelijkheidspictogram in de navigatiebalk of door
                op
                <strong>Alt + A</strong>
...
CONFORMITEITSSTATUS
De Web Content Accessibility Guidelines (WCAG) definiëren eisen voor ontwerpers en ontwikkelaars om de toegankelijkheid voor mensen met een beperking te verbeteren. De WCAG definiëren drie conformiteitsniveaus: Niveau A, Niveau AA en Niveau AAA.
...
Toegang tot de widget via het toegankelijkheidspictogram in de navigatiebalk of door op Alt + A te drukken. Uw voorkeuren worden tussen bezoeken opgeslagen via lokale browseropslag.
...
Access the widget using the accessibility icon in the navigation bar or by pressing Alt + A. Your preferences are saved between visits using browser local storage.
