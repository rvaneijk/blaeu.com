      ...
      <div class="accessibility-policy-widget-content">
        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div class="download-link-summary">
            <a
              href="#"
              class="text-blue-600 hover:underline flex items-center justify-center text-sm"
        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <p class="mt-2 text-sm text-gray-600">
                We are continually working to improve our AAA compliance, with current focus areas
                including more descriptive link text and developing a glossary for specialized
                terminology.
              </p>
            </section>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <p class="mt-2 text-sm text-gray-600">
                We werken voortdurend aan het verbeteren van onze AAA-compliance, met huidige
                aandachtsgebieden waaronder meer beschrijvende linkteksten en het ontwikkelen van
                een woordenlijst voor gespecialiseerde terminologie.
              </p>
            </section>
            ...
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Feedback</h3>
              <p>
                Wij verwelkomen uw feedback over de toegankelijkheid van deze website. Als u
                toegankelijkheidsbarrières ondervindt of suggesties heeft voor verbetering, neem dan
                contact met ons op via team@blaeu.com.
              </p>
            </section>
