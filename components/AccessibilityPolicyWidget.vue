        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div class="download-link-summary">
            <a href="#" @click.prevent="downloadPolicy" class="text-blue-600 hover:underline flex items-center justify-center text-sm">
              ...
              {{ currentLanguage === 'nl' ? 'Download toegankelijkheidsverklaring' : 'Download accessibility statement' }}
            </a>
          </div>
        </div>
        ...
        <div v-else id="full-policy-content" class="full-policy">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <ul class="custom-bullet-list mt-2 space-y-2">
                ...
                <li>ARIA attributes and live regions for screen readers with proper announcements</li>
                <li>High color contrast exceeding AA standards (4.5:1 ratio) with AAA enhancements (7:1 ratio)</li>
                ...
                <li>Comprehensive accessibility widget with user-controlled settings and preference memory</li>
            ...
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Compatibility with Assistive Technologies</h3>
              ...
              <p class="mt-2">We strive to ensure compatibility with the latest versions of these technologies and regularly test with assistive technology users.</p>
            </section>
            ...
            <section class="mt-6">
              ...
              <ul class="custom-bullet-list space-y-1">
                ...
                <li><strong>Alt + 2:</strong> Jump to navigation menu</li>
                <li><strong>Alt + 3:</strong> Jump to footer/contact section</li>
              </ul>
              
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Accessibility Features</h4>
              <ul class="custom-bullet-list space-y-1">
                <li><strong>Alt + A:</strong> Toggle accessibility widget</li>
                <li><strong>Alt + F:</strong> Toggle focus mode (highlight the currently focused element)</li>
                <li><strong>Alt + X:</strong> Toggle high contrast mode</li>
                <li><strong>Alt + Z:</strong> Toggle reduced motion (pauses videos and animations)</li>
              </ul>
              
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Utility Shortcuts</h4>
              <ul class="custom-bullet-list space-y-1">
                <li><strong>Alt + 0:</strong> Back to top</li>
                <li><strong>Alt + /:</strong> Open keyboard shortcuts help dialog</li>
                <li><strong>Alt + L:</strong> Switch to left-handed mode</li>
                <li><strong>Alt + R:</strong> Switch to right-handed mode</li>
              </ul>
              
              <p class="mt-3 text-sm italic">Note: Some keyboard shortcuts may not work if they conflict with your browser or assistive technology shortcuts.</p>
            </section>
            
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Accessibility Widget</h3>
              <p>Our website includes an accessibility widget that allows you to customize your experience. You can:</p>
              <ul class="custom-bullet-list mt-2 space-y-1">
              ...
              <p class="mt-2">Access the widget using the accessibility icon in the bottom right corner of the screen or by pressing <strong>Alt + A</strong>. Your preferences are saved between visits using browser local storage.</p>
            </section>
            ...
            <section class="mt-6">
              ...
              <p class="mt-2 text-sm text-gray-600">We are continually working to improve our AAA compliance, with current focus areas including more descriptive link text and developing a glossary for specialized terminology.</p>
            </section>

            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Feedback</h3>
              <p>We welcome your feedback on the accessibility of this website. If you encounter accessibility barriers or have suggestions for improvement, please contact us at team@blaeu.com.</p>
            </section>

            <section class="mt-6">
            <p class="text-sm text-gray-500 mt-8">If there is an inconsistency between the Dutch and English-language version of this statement, the Dutch version takes precedence.</p>
            </section>
          ...
          <div v-else class="prose max-w-none text-gray-800">
            ...
            <section class="mt-6">
              ...
              <p>De Web Content Accessibility Guidelines (WCAG) definieert eisen voor ontwerpers en ontwikkelaars om de toegankelijkheid voor mensen met een beperking te verbeteren. Het definieert drie conformiteitsniveaus: Niveau A, Niveau AA en Niveau AAA.</p>
              <p class="mt-2">De website bestaat uit twee pagina's (homepage met stille video en een persoonlijke pagina) zonder formulieren, invoervelden of authenticatiemechanismen. Deze formuliervrije aanpak vermindert aanzienlijk mogelijke toegankelijkheidsbarrières voor gebruikers met een beperking. Voor zover wij weten is deze website volledig conform WCAG 2.2 niveau A-standaarden, met de meeste AA- en verschillende AAA-verbeteringen.</p>
            </section>
            ...
            <section class="mt-6">
              ...
              <ul class="custom-bullet-list mt-2 space-y-2">
                ...
                <li>Doorspring-link naar inhoud met verbeterde zichtbaarheid en meerdere navigatiemogelijkheden</li>
                <li>ARIA-attributen en live-regio's voor schermlezers met correcte aankondigingen</li>
                <li>Hoog kleurcontrast dat AA-standaarden overtreft (4.5:1 ratio) met AAA-verbeteringen (7:1 ratio)</li>
                ...
                <li>Uitgebreide toegankelijkheidswidget met door de gebruiker bestuurbare instellingen en voorkeursgeheugen</li>
            ...
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Compatibiliteit met Hulptechnologieën</h3>
              <p>Onze website is ontworpen om compatibel te zijn met de volgende hulptechnologieën:</p>
              <ul class="custom-bullet-list mt-2 space-y-1">
              ...
              <p class="mt-2">We streven ernaar compatibiliteit te garanderen met de nieuwste versies van deze technologieën en testen regelmatig met gebruikers van ondersteunende technologieën.</p>
            </section>
            
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Toetsenbordsnelkoppelingen</h3>
              <p>De volgende toetsenbordsnelkoppelingen zijn beschikbaar om door de website te navigeren:</p>
              
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Primaire Navigatie</h4>
              <ul class="custom-bullet-list space-y-1">
                <li><strong>Alt + 1:</strong> Spring naar hoofdinhoud</li>
                <li><strong>Alt + 2:</strong> Spring naar navigatiemenu</li>
                <li><strong>Alt + 3:</strong> Spring naar footer/contactgedeelte</li>
              </ul>
              
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Toegankelijkheidsfuncties</h4>
              <ul class="custom-bullet-list space-y-1">
                <li><strong>Alt + A:</strong> Toegankelijkheidswidget aan/uit</li>
                <li><strong>Alt + F:</strong> Focusmodus aan/uit (markeert het momenteel gefocuste element)</li>
                <li><strong>Alt + X:</strong> Hoog contrast modus aan/uit</li>
                <li><strong>Alt + Z:</strong> Verminderde beweging aan/uit (pauzeert video's en animaties)</li>
              </ul>
              
              <h4 class="text-lg font-medium mt-4 mb-2 text-gray-800">Hulpsnelkoppelingen</h4>
              <ul class="custom-bullet-list space-y-1">
                <li><strong>Alt + 0:</strong> Terug naar boven</li>
                <li><strong>Alt + /:</strong> Open hulpdialoog voor toetsenbordsnelkoppelingen</li>
                <li><strong>Alt + L:</strong> Schakel naar linkshandige modus</li>
                <li><strong>Alt + R:</strong> Schakel naar rechtshandige modus</li>
              </ul>
              
              <p class="mt-3 text-sm italic">Opmerking: Sommige toetsenbordsnelkoppelingen werken mogelijk niet als ze conflicteren met snelkoppelingen van uw browser of ondersteunende technologie.</p>
            </section>
            
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Toegankelijkheidswidget</h3>
              <p>Onze website bevat een toegankelijkheidswidget waarmee u uw ervaring kunt aanpassen. U kunt:</p>
              <ul class="custom-bullet-list mt-2 space-y-1">
              ...
              <p class="mt-2">Toegang tot de widget via het toegankelijkheidspictogram in de rechteronderhoek van het scherm of door op <strong>Alt + A</strong> te drukken. Uw voorkeuren worden tussen bezoeken opgeslagen via lokale browseropslag.</p>
            </section>
            
            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">WCAG 2.2 AAA Verbeteringen</h3>
              <p>Onze website implementeert verschillende WCAG 2.2 Niveau AAA-succescriteria, waaronder:</p>
              <ul class="custom-bullet-list mt-2 space-y-1">
                <li>Verbeterde contrastverhoudingen (7:1 ratio) voor tekst en interface-elementen</li>
              ...
              <p class="mt-2 text-sm text-gray-600">We werken voortdurend aan het verbeteren van onze AAA-compliance, met huidige aandachtsgebieden waaronder meer beschrijvende linkteksten en het ontwikkelen van een woordenlijst voor gespecialiseerde terminologie.</p>
            </section>

            <section class="mt-6">
              <h3 class="text-xl font-semibold mb-2 text-gray-800">Feedback</h3>
              <p>Wij verwelkomen uw feedback over de toegankelijkheid van deze website. Als u toegankelijkheidsbarrières ondervindt of suggesties heeft voor verbetering, neem dan contact met ons op via team@blaeu.com.</p>
            </section>
...
defineExpose({
  openWidget: (language) => {
    currentLanguage.value = language || 'nl';
    isOpen.value = true;
...
const downloadPolicy = () => {
  ...
  const fileName = isNL ? 'toegankelijkheidsverklaring-blaeu.txt' : 'accessibility-statement-blaeu.txt';
  
  // Generate the content based on the selected language
  let content = '';
  
  if (isNL) {
    content = `TOEGANKELIJKHEIDSVERKLARING - TEAM BLAEU (BLAEU PRIVACY RESPONSE TEAM B.V.)
...
Bij een inconsistentie tussen de Nederlandse en Engelstalige versie van deze verklaring, heeft de Nederlandse versie voorrang.`;
    ...
    content = `ACCESSIBILITY STATEMENT - TEAM BLAEU (BLAEU PRIVACY RESPONSE TEAM B.V.)
...
If there is an inconsistency between the Dutch and English-language version of this statement, the Dutch version takes precedence.`;
  ...
  if ($announce) {
    $announce(
      isNL ? 'Toegankelijkheidsverklaring wordt gedownload' : 'Accessibility statement is being downloaded',
      'polite'
    );
  }
};
...
onMounted(() => {
  ...
  document.addEventListener('open-accessibility-policy', (event) => {
...
onBeforeUnmount(() => {
  ...
  document.removeEventListener('open-accessibility-policy', null);
});
</script>
