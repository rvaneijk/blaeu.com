...
-->
<template>
  <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-blue" role="listitem">
    ...
    <div class="flex justify-between items-center mt-4">
      <div>
        <span :class="[categoryBgClass, categoryTextClass, 'inline-block px-3 py-1 rounded-full text-xs']">
          {{ category }}
        </span>
      </div>
      <a
