...
<script setup lang="ts">
  ...
  const isProfessionalTraining = (venue: string, publisher: string, _title: string): boolean => {
    return (
      venue.includes('fpf training') ||
      venue.includes('training program') ||
      venue.includes('digital data flows masterclass') ||
      venue.includes('masterclass') ||
      venue.includes('iab') ||
      publisher.includes('iab') ||
  ...
  const isRegulatorySession = (venue: string, publisher: string, title: string): boolean => {
    return (
      ...
      venue.includes('authority') ||
      publisher.includes('commission') ||
      publisher.includes('authority') ||
  ...
  onMounted(async () => {
    try {
      ...
      mediaData.value = professionalLearningData as MediaContentData
