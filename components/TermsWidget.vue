        ...
        <div v-if="!isPolicyExpanded" class="policy-summary">
          ...
          <div v-if="currentLanguage === 'en'" class="prose max-w-none text-gray-800">
            ...
            <ul class="list-disc pl-6 space-y-1 text-sm">
              <li>Blaeu Privacy Response Team B.V. (hereinafter: Team Blaeu) is a private limited company registered at the Dutch Chamber of Commerce under no. 75599740.</li>
