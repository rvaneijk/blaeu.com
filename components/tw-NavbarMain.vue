    ...
    >
      ...
      <div class="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
        <a
          ...
          :aria-current="activeSection === 'top' ? 'page' : undefined"
          @click.prevent="handleMenuClick('#top')"
        >
        ...
        <a
          ...
          :tabindex="mobileMenuOpen ? '0' : '-1'"
          :aria-current="activeSection === 'about-us' ? 'page' : undefined"
          @click.prevent="handleMenuClick('#about-us')"
        >
          <span class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          ...
          :tabindex="mobileMenuOpen ? '0' : '-1'"
          :aria-current="activeSection === 'expertise' ? 'page' : undefined"
          @click.prevent="handleMenuClick('#expertise')"
        >
          <span class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          ...
          :tabindex="mobileMenuOpen ? '0' : '-1'"
          :aria-current="activeSection === 'news' ? 'page' : undefined"
          @click.prevent="handleMenuClick('#news')"
        >
          <span class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
<script setup lang="ts">
  ...
  const mobileMenuRef = ref<HTMLElement | null>(null) // Reference to mobile menu DOM element
   ...
   * Updates scroll tracking and the currently active section for navigation highlighting
   */
        ...
        newPosition => {
          ...
          if (backToTopBtn) {
            ...
            if (newPosition === 'bottom-left') {
              ;(backToTopBtn as HTMLElement).style.left = '20px'
              ;(backToTopBtn as HTMLElement).style.right = 'auto'
              // Force reflow
              backToTopBtn.classList.remove('right-aligned')
              backToTopBtn.classList.add('left-aligned')
            } else {
              ;(backToTopBtn as HTMLElement).style.right = '20px'
              ;(backToTopBtn as HTMLElement).style.left = 'auto'
              // Force reflow
              backToTopBtn.classList.remove('left-aligned')
              backToTopBtn.classList.add('right-aligned')
            }
