...
<template>
  ...
  <nav 
    class="fixed w-full z-10 transition-all duration-300 top-0" 
       ...
       <div class="flex items-center ml-2">
        ...
        <div class="hidden md:flex md:items-center md:space-x-8 font-amblelight" role="navigation" aria-label="Desktop Navigation" tabindex="-1">
          ...
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'about-us', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'about-us',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'about-us' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'about-us' && !scrolled
            }"
          ...
          <a 
            ...
            class="font-medium text-base transition-all duration-200 inline-flex items-center"
            :class="{
              'text-gray-700 hover:text-blue-600': scrolled && activeSection !== 'expertise', 
              'text-white hover:text-gray-200': !scrolled && activeSection !== 'expertise',
              'text-blue-600 border-b-2 border-blue-600': activeSection === 'expertise' && scrolled,
              'text-white border-b-2 border-white': activeSection === 'expertise' && !scrolled
            }"
 ...
 */
const scrolled = ref(false);              // Whether page has been scrolled past threshold
...
const updateActiveSection = () => {
  if (process.client) {
    ...
    const sections = ['about', 'expertise', 'about-us', 'top'];
