    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
        ...
        >
          ...
          <div class="mt-auto flex flex-col" style="gap: 0.0625rem !important; line-height: 1.2 !important;">
            <a
              :href="item.primaryLink.url"
              target="_blank"
            ...
            >
              <i class="fas fa-external-link-alt fa-xs text-brand-gold"></i>
              Read more
...
const newsItems = computed((): NewsItem[] => {
  return sortedFeaturedItems.map(item => {
    const primaryLink = item.links.find(link => link.type === 'external') || item.links[0]
