        ...
        >
          ...
          >
            <a
              ...
              class="no-external-icon underline underline-offset-2 transition-colors duration-200 text-left leading-tight !p-0"
              :title="item.primaryLink.title"
            >
              {{ item.title }}
              <i
                v-if="item.primaryLink.type === 'external'"
                class="fa-solid fa-external-link relative top-[-0.35em] ml-[0.2em] text-[0.65em]"
                aria-hidden="true"
              ></i>
            </a>
          </h3>
