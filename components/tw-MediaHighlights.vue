...
<template>
  <section id="media" class="pt-8 pb-8 bg-gray-50 font-amblelight">
    <div class="container mx-auto px-4">
      ...
      >
        <!-- Media Column -->
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              role="button"
              aria-label="View media coverage portfolio"
              aria-haspopup="dialog"
              @click.prevent="openMediaModal"
              @keydown.enter.prevent="openMediaModal"
            >
              <i class="fa-solid fa-newspaper fa-xs text-brand-gold"></i>
              View Media Coverage
            </a>
          </div>
        </div>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View speaking portfolio"
              aria-haspopup="dialog"
              @click.prevent="openKeynoteModal"
              @keydown.enter.prevent="openKeynoteModal"
            >
              <i class="fa-solid fa-microphone fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View panel appearances portfolio"
              aria-haspopup="dialog"
              @click.prevent="openPanelModal"
              @keydown.enter.prevent="openPanelModal"
            >
              <i class="fa-solid fa-users fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View popular media portfolio"
              aria-haspopup="dialog"
              @click.prevent="openPopularModal"
              @keydown.enter.prevent="openPopularModal"
            >
              <i class="fa-solid fa-video fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View professional publications portfolio"
              aria-haspopup="dialog"
              @click.prevent="openProfessionalModal"
              @keydown.enter.prevent="openProfessionalModal"
            >
              <i class="fa-solid fa-edit fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View scholarly works portfolio"
              aria-haspopup="dialog"
              @click.prevent="openScholarlyModal"
              @keydown.enter.prevent="openScholarlyModal"
            >
              <i class="fa-solid fa-book fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View interactive training portfolio"
              aria-haspopup="dialog"
              @click.prevent="openLearningModal"
              @keydown.enter.prevent="openLearningModal"
            >
              <i class="fa-solid fa-filter fa-xs text-brand-gold"></i>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md flex flex-col border-l-4 border-brand-grey" role="listitem">
          ...
          <div class="mt-4">
            <a
              ...
              class="inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 text-sm font-medium transition-colors duration-200"
              role="button"
              aria-label="View academic teaching portfolio"
              aria-haspopup="dialog"
              @click.prevent="openAcademicModal"
              @keydown.enter.prevent="openAcademicModal"
            >
              <i class="fa-solid fa-graduation-cap fa-xs text-brand-gold"></i>
