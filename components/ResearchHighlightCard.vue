    ...
    <div class="p-6">
      ...
      >
        ...
        <a
          ...
          class="no-external-icon inline-flex items-center gap-2 text-brand-grey hover:text-gray-800 dark:hover:text-gray-200 text-sm font-medium transition-colors duration-200"
        ...
        <template v-for="link in item.links" :key="`archives-${link.url}`">
          <a
            ...
            class="no-external-icon inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-sm transition-colors duration-200"
            style="margin: 0 !important; padding: 0 !important"
          >
