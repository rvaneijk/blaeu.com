...
export type MediaType =
  ...
  | 'slides'
  | 'academic'
type DisplayContext = 'modal' | 'highlight' | 'card' | 'list'
...
export const CATEGORY_STYLES: Record<string, { bg: string; text: string }> = {
  interview: { bg: 'bg-blue-700', text: 'text-white' },
  podcast: { bg: 'bg-brand-gold', text: 'text-black' },
  panel: { bg: 'bg-blue-700', text: 'text-white' },
  keynote: { bg: 'bg-brand-gold', text: 'text-black' },
  television: { bg: 'bg-blue-700', text: 'text-white' },
  radio: { bg: 'bg-brand-gold', text: 'text-black' },
  other: { bg: 'bg-blue-700', text: 'text-white' },
  conference: { bg: 'bg-brand-gold', text: 'text-black' },
  report: { bg: 'bg-blue-700', text: 'text-white' },
  blogpost: { bg: 'bg-brand-gold', text: 'text-black' },
  slides: { bg: 'bg-blue-700', text: 'text-white' },
