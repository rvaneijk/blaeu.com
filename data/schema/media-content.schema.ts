...
export type LinkType = 'external' | 'download' | 'video' | 'archive' | 'podcast' | 'play' | 'pdf' | 'web'
export type ContentType = 'publication' | 'media' | 'presentation' | 'service' | 'teaching' | 'training' | 'research' | 'highlight'
export type MediaType = 'interview' | 'podcast' | 'panel' | 'television' | 'radio' | 'keynote' | 'conference' | 'other' | 'report' | 'blogpost' | 'slides' | 'academic'
