        ...
        <section class="mb-10">
          ...
          <div class="flex flex-col md:flex-row items-start gap-6 mb-4">
            <div class="shrink-0 w-32 md:w-40 md:-ml-10">
              <img
                src="/assets/img/tiny_samman.webp"
                alt="Cover of From Pseudonymised to Anonymous Data"
                class="w-full h-auto"
                width="160"
                height="227"
                loading="lazy"
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">
                Cabinet SAMMAN &amp; Team Blaeu (2026)
              </p>
              <p class="text-gray-700 dark:text-gray-300 leading-relaxed">
                In this joint policy report with Benjamin de Vanssay, we set out a practical
                framework for assessing when pseudonymised data becomes anonymous under the SRB
                ruling. We apply the framework to real use cases provided by European companies.
              </p>
            </div>
          </div>
          <a
            href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6972998"
            target="_blank"
            rel="noopener"
          ...
          <div class="flex flex-col md:flex-row items-start gap-6 mb-4 mt-8">
            <div class="shrink-0 w-32 md:w-40 md:-ml-10">
              <img
...
<script setup lang="ts">
  ...
  const description =
    'Rob van Eijk, Senior Fellow at Future of Privacy Forum and former Dutch DPA official. EU regulatory affairs, AI governance, and data protection expert.'
