  ...
  <div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
    ...
    <main id="main-content" class="pt-12 flex-1">
      ...
      >
        <div class="max-w-2xl mx-auto px-4">
          <h2
            class="text-2xl font-bold mb-3 pb-3 border-b border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 leading-tight tracking-tight"
          >
            {{ section.label }}
          </h2>
...
<script setup lang="ts">
  ...
  const sections = [
    { anchor: 'panels', label: 'Keynotes & Panels', component: markRaw(TabContent7) },
    ...
    { anchor: 'teaching', label: 'Teaching', component: markRaw(TabContent8b) },
    { anchor: 'popular-media', label: 'Public Engagement', component: markRaw(TabContent4) },
  ]

  const title = 'Professional Portfolio | Rob van Eijk'
  const description =
    'Rob van Eijk in NYT, Bloomberg, POLITICO. Keynotes at OECD and WP29, scholarly works, and committee work across fifteen years of EU regulatory engagement.'
