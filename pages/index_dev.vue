...
<script setup>
  ...
  const description =
    'Team Blaeu provides expert consulting on data architecture legal aspects, specializing in privacy, data protection, and compliance solutions.'
  const ogTitle = 'Team Blaeu | Data Privacy and Compliance Experts (Dev)'
  const ogImage = '/assets/img/og-image.webp'
  const _ogImageJpg = '/assets/img/og-image.jpg' // Fallback
  const twitterCardWebp = '/assets/img/twitter-card.webp'
  const _twitterCardJpg = '/assets/img/twitter-card.jpg' // Fallback
  const mySite = 'https://blaeu.com/main_dev'
  ...
  useHead({
    htmlAttrs: { lang: 'en' },
    charset: 'utf-8',
    title: 'Team Blaeu | Privacy & Data Protection Consulting (Dev)',
    meta: [
      // Basic meta tags
      { name: 'description', content: description },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { name: 'author', content: 'Team Blaeu' },
      { name: 'robots', content: 'noindex, nofollow' }, // Dev version should not be indexed
