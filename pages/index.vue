...
<template>
  <div class="min-h-screen overflow-x-hidden">
    ...
    <main id="main-content" class="pt-0" tabindex="-1" aria-label="Main content">
      ...
      <!-- Fixed background video (positioned behind all content) -->
...
<script setup>
  ...
  useHead({
    ...
    link: [
      ...
      { rel: 'preload', href: ogImage, as: 'image', type: 'image/webp' },
    ],
    script: [
      {
...
/* You may need to exclude certain links like navigation items that have their own hover styles */
nav a:hover {
  /* Keep existing nav hover styles */
}
