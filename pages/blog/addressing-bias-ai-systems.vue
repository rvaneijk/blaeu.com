      ...
      <article class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="prose prose-lg max-w-none">
          ...
          <p class="mb-4">
            ...
            <i class="fa-solid fa-external-link fa-sm text-brand-gold"></i>
            facilitated the recording of the workshop. You can watch the recording of the workshop
            <a
...
<script setup>
  ...
  // SEO meta
  useSeoMeta({
    title: 'Addressing Bias in AI Systems: A Holistic Approach | Team Blaeu',
    description:
