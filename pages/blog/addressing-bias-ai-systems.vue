  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <main id="main-content" class="pt-12">
      <article class="max-w-4xl mx-auto px-4 py-8">
        <!-- Post Header -->
        <header class="mb-8">
          <BlogBreadcrumbs title="Addressing Bias in AI Systems" />
          ...
          >
            ...
            <div class="flex items-center gap-2">
              <i class="fas fa-users fa-sm text-brand-gold" aria-hidden="true"></i>
        ...
        <div class="mb-8">
          ...
          <p class="blog-caption text-sm text-gray-600 dark:text-gray-400 mt-2 italic">
            ...
            <span class="text-yellow-800 font-medium">central golden areas</span>
            represent successful bias detection and mitigation achievements, while
            <span class="text-teal-700 font-medium">inclusive teal fields</span>
        ...
        <div class="prose prose-lg dark:prose-invert">
          ...
          <p class="mb-4">
            ...
            , AI Audit and Assurance Officer at Holistic AI, took the floor with a presentation on
            the question: how to perform a bias assessment? This post summarizes what I learned from
            the presenters while preparing and moderating the workshop. The presenters were tasked
            to explain a complex technical topic to a non-technical audience. In passing, I will
          ...
          <p class="mb-4">
            ...
            groups—however, neither guarantees complete fairness. Equal Opportunity Difference
          ...
          <p class="mb-4">
            ...
            used by the NYC Local Law 144 (see Phase 1: Assessment – Equality of Outcome).
          </p>
...
<script setup>
  ...
  const description =
    'Recap of the FPF workshop on bias assessment in AI systems, covering detection, reporting, mitigation frameworks, intersectionality, and GDPR impact.'
  const ogImage =
    'https://blaeu.com/assets/blog/rothko-abstracts/addressing-bias-ai-systems-2023.svg'
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'Addressing Bias in AI Systems', item: pageUrl },
    ],
  }
  ...
  useHead({
    ...
    meta: [
      ...
      { property: 'og:image:alt', content: 'Addressing Bias in AI Systems abstract composition' },
